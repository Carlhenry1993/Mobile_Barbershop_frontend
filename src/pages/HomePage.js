...
// <-- AJOUT WHATSAPP : Remplace par le vrai numéro de Mr Renaudin
const WHATSAPP_NUMBER = "15147788318"; // Format international sans + ni espaces
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: "900px" }}>
          ...
          >
            ...
            {/* <-- AJOUT WHATSAPP AVEC STYLE IDENTIQUE AUX AUTRES */}
            <a
              href={WHATSAPP_LINK}
              target="_blank"
              rel="noopener noreferrer"
